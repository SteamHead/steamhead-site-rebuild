---
title: Simple Circuits — Teacher Guide
description: Teacher preparation, timing, facilitation notes, and troubleshooting for three Simple Circuits lessons. Companion to the Shared Activity Guide.
---
...
- [ ] **Test your LEDs** before class — discard any dead ones
- [ ] **Check batteries** — CR2032s lose charge over time; test a few
- [ ] **Set up tables** with shared materials in the centre
- [ ] **Project** the shared guide at [/guides/simple-circuits-shared/](/guides/simple-circuits-shared/)

### Lesson 1 additions:
- [ ] White paper or cardstock (1–2 sheets per student)
- [ ] Markers, crayons, or colored pencils at each table
- [ ] If doing the book extension: clear a spot near the classroom bookshelf or pull a selection of picture books to each table
- [ ] If doing the greeting card extension: pre-fold a sample card to show students

### Lesson 2 additions:
- [ ] **Print** paper circuit templates (1 per student) — [Circuits Worksheet PDF](https://drive.google.com/file/d/1vigo3MQ-5jSZC4kEySyaskHq2b2xBJgw/view?usp=sharing)
- [ ] **Print** hoodie templates (1 per student) — [Hoodie Template PDF](https://drive.google.com/file/d/1WIxNKJfzipB7LfXzIw8X9vmIV13D/view?usp=sharing)
- [ ] **Pre-cut** copper tape into ~30 cm strips per student

### Lesson 3 additions:
- [ ] Fabric scraps or old t-shirt pieces (one fist-sized piece per student)
- [ ] Copper tape ~60 cm per student
- [ ] If doing conductive thread extension: conductive thread and needles
...
| Optional: Electricity video (Grades 3+) | 5–10 min | [YouTube link](https://www.youtube.com/watch?v=MrLWLWpS1Gw) |
...
The [Full Semester Guide](/guides/mfedu-full-semester-guide/) covers the complete arc from storytelling through runway exhibition.

---

## Credits

Activities adapted from the MakeFashion Edu Introduction Course.
Original curriculum by Twila Busby, Carrie Leung, and Elisa Busby.
